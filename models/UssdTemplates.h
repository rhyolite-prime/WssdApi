...
class UssdTemplates
{
  public:
     ...
     */
    explicit UssdTemplates(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UssdTemplates(const Json::Value &pJson) noexcept(false);
     ...
     */
    UssdTemplates(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    UssdTemplates() = default;
    ...
    /**  For column language_code  */
    ///Get the value of the column language_code, returns the default value if the column is null
    const std::string &getValueOfLanguageCode() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getLanguageCode() const noexcept;
    ///Set the value of the column language_code
    void setLanguageCode(const std::string &pLanguageCode) noexcept;
    void setLanguageCode(std::string &&pLanguageCode) noexcept;
    void setLanguageCodeToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<UssdTemplates>;
    friend drogon::orm::BaseBuilder<UssdTemplates, true, true>;
    friend drogon::orm::BaseBuilder<UssdTemplates, true, false>;
    friend drogon::orm::BaseBuilder<UssdTemplates, false, true>;
    friend drogon::orm::BaseBuilder<UssdTemplates, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UssdTemplates>;
#endif
